...
//        role.setRoleId(2L);
    ...
    public Question approveQuestion(@PathVariable("id") Long id){
    ...
    public Answer approveAnswer(@PathVariable("id") Long id){
    ...
    public Answer disableAnswer(@PathVariable("id") Long id){
        Answer answer = this.answerRepository.getAnswerById(id);
        answer.setId(id);
    ...
    public Integer deleteAnswerById(@PathVariable("id") Long id){
